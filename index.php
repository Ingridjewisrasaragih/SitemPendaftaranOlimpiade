...
<body style="background-color:#E9967A"
     <!-- Navbar -->
     <nav class="navbar navbar-expand-lg navbar-calm bg-calm text-uppercase">
          <div class="container">
               <a class="navbar-brand" href="index.php">Sistem Data Siswa Olimpiade </a>
          ...
          <div class="row bg-light text-black text-center">
               <div class="col my-2" id="about">
                    ...
                    <p>
                         ...
                         Ingrid Jewisra Saragih (12030122120050)
                    </p>
               </div>
          </div>
     </div>
